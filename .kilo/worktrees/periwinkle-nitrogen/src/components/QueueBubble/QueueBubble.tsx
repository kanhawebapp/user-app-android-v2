  ...
  const panResponder = useRef(
    PanResponder.create({
      onMoveShouldSetPanResponder: (_, gesture) => {
        return !isExpanded && Math.abs(gesture.dy) > 5;
      },
        ...
        <ScrollView
          ...
          <View style={styles.card}>
            ...
            <InfoRow
              ...
              value={formatTime(queueTimeLeft)}
            />
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.moreText}>
              Please stay connected while we prepare your
              consultation. Do not close the app during
              queue process.
            </Text>

            <Text style={styles.moreText}>
              You will automatically connect once your turn
              arrives.
            </Text>
          </View>
