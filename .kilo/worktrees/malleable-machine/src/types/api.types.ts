...
export interface GetAstrologersResponse extends PaginatedResponse<AstrologerProfile> {}

export interface GetAstrologerDetailParams {
  astrologerId: string;
}

export interface GetAstrologerDetailResponse extends ApiResponse<AstrologerProfile> {}
...
export interface GetAstrologerReviewsResponse extends PaginatedResponse<AstrologerReview> {}

export interface FollowAstrologerParams {
  astrologerId: string;
}

export interface FollowAstrologerResponse extends ApiResponse<{ isFollowing: boolean }> {}
...
export interface GetTransactionsResponse extends PaginatedResponse<WalletTransaction> {}
...
export interface GetChatHistoryResponse extends PaginatedResponse<ChatMessage> {}
...
export interface GetActiveChatsResponse extends PaginatedResponse<ChatSession> {}
...
export interface InitiateCallResponse extends ApiResponse<{
  session: CallSession;
  rtcToken: string;
  channelName: string;
}> {}
...
export interface GetRTCTokenResponse extends ApiResponse<{
  token: string;
  channelName: string;
  uid: number;
}> {}
...
export interface GetCallHistoryResponse extends PaginatedResponse<CallSession> {}
...
export interface GetActiveSessionResponse extends ApiResponse<{
...
export interface CrashRecoveryResponse extends ApiResponse<{
  activeSession: {
    id: string;
    type: string;
    status: string;
...
export interface GetNotificationsResponse extends PaginatedResponse<AppNotification> {}

export interface MarkNotificationReadParams {
  notificationId: string;
}

export interface MarkNotificationReadResponse extends ApiResponse<AppNotification> {}
...
export interface UpdateNotificationPreferencesResponse extends ApiResponse<NotificationPreference> {}
