...
export const getFieldsForFeature = (feature: FeatureType): ProfileFieldKey[] => {
...
export const hasRequiredFields = (
  ...
  return requirement.requiredFields.every(field => completedFields.includes(field));
};
...
export const getMissingFields = (
  ...
  return requirement.requiredFields.filter(field => !completedFields.includes(field));
};
