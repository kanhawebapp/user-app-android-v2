...
export const HeroBanner: React.FC<HeroBannerProps> = ({
  ...
  // console.log("item.imageUrl hereee", infiniteBanners.map(item => item.imageUrl));
  ...
  const getBannerImageUrl = (imageUrl?: string) => {
    ...
    return imageUrl
      .replace('https://api.dhwaniastro.com', `${API_BASE_URL.DEVELOPMENT}`)
      .replace('http://api.dhwaniastro.com', `${API_BASE_URL.DEVELOPMENT}`);
    // return imageUrl
    //   .replace('https://api.dhwaniastro.com', 'https://dhwaniastro.com')
    //   .replace('http://api.dhwaniastro.com', 'https://dhwaniastro.com');
  };
            ...
            <TouchableOpacity
              ...
              {/* <ImageBackground
                ...
                source={
                  typeof item.imageUrl === 'string'
                    ? { uri: item.imageUrl }
                    : item.imageUrl || DEFAULT_BANNER_IMAGE
                }
                style={styles.imageBackground}
                imageStyle={styles.imageStyle}
              /> */}
              <ImageBackground
                source={
                  typeof item.imageUrl === 'string'
                    ? {
                        uri: getBannerImageUrl(item.imageUrl),
                      }
                    : item.imageUrl || DEFAULT_BANNER_IMAGE
                }
                style={styles.imageBackground}
