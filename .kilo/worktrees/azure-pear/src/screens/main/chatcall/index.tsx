...
const ChatCallScreen: React.FC<ChatCallScreenProps> = ({
  ...
  useEffect(() => {
    ...
    if (
      ...
      console.log('[ChatCallScreen] Setting showChatScreen=true');
  ...
  return (
    <ConsultationFlowLayer
      ...
      {({startChat, startCall, runIfAuthenticated, selectedAstrologer}) => {
        ...
        console.log('[ChatCallScreen] ChatScreen bridge render check', {
          showChatScreen,
          ...
          shouldNavigateToChat,
          userData: !!userData,
          selectedAstrologerId: selectedAstrologer?.id,
          storeSelectedAstrologerId: storeSelectedAstrologer?.id,
          astroToUseId: astroToUse?.id,
          willRenderChat: !!(showChatScreen && astroToUse && userData),
        });
        ...
        if (showChatScreen && !(astroToUse && userData)) {
          console.log('[ChatCallScreen] ChatScreen render blocked', {
            showChatScreen,
            hasNavigated: hasNavigatedRef.current,
            astroToUseId: astroToUse?.id,
            userData: !!userData,
