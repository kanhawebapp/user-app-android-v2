...
export const ConsultationFlowLayer: React.FC<ConsultationFlowLayerProps> = ({
  ...
  const closeChatRequestModal = useCallback(() => {
    console.log('[ConsultationFlowLayer] closeChatRequestModal', {
      selectedAstrologerId: selectedAstrologer?.id,
      consultationType,
    });
    setShowChatRequestModal(false);
    setSelectedAstrologer(null);
  }, [consultationType, selectedAstrologer]);
  ...
  const handleSubmit = useCallback(
    (formData: ChatRequestData) => {
      console.log('[ConsultationFlowLayer] submitConsultationRequest called', {
