...
//       console.log('[BLOCKED_DUPLICATE_REQUEST]');
//       return;
//     }
...
//       console.log('[HANDLE_SUBMIT_SUCCESS]');

//       onClose();
//     } catch (e) {
//       console.log('[HANDLE_SUBMIT_ERROR]', e);
//     } finally {
//       requestInProgressRef.current = false;
//     }
//   }, [
...
//                     <Text
//                       numberOfLines={1}
//                       style={[styles.intakeName, {color: colors.text.primary}]}>
//                       {item.name}
//                     </Text>
...
//                         {
//                           backgroundColor:
//                             item.gender === 'FEMALE' ? '#FFEEF3' : '#EEF4FF',
//                         },
//                       ]}>
