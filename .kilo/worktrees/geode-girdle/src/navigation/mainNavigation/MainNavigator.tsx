...
import type { ProblemCategory } from '../../screens/main/home/types';
...
const MainNavigator: React.FC<MainNavigatorProps> = ({
  ...
  useEffect(() => {
   ...
   const [isProblemBaseAstroScreenVisible, setIsProblemBaseAstroScreenVisible] = useState(false);
  ...
  const handleNotificationPress = useCallback(() => {
   ...
   const handleNavigateToProblemBaseAstroScreen = useCallback((category: ProblemCategory) => {
      ...
      {!isChatActive && (
       ...
       <View style={styles.screenContainer}>
         {renderScreen({
           ...
           onNavigateToAstrologerList,
           handleNavigateToTab,
           onNavigateToProblemBaseAstroScreen: handleNavigateToProblemBaseAstroScreen,
         })}
       </View>
