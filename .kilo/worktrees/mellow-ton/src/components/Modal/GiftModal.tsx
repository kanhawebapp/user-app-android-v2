...
export const GiftModal: React.FC<GiftModalProps> = ({
  ...
  const offerColor = useMemo(() => getOfferColor(offerType, colors), [offerType, colors]);
    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          {offerType === 'bonus' && (
            <Text variant="captionSmall" style={{ color: colors.common.white, marginTop: 2 }}>
              BONUS
            </Text>
          )}
        </View>
        ...
        <View style={styles.featuresContainer}>
          <View style={styles.featureItem}>
            <Icon
              ...
              library="MaterialIcons"
            />
            <Text variant="bodySmall" style={[styles.featureText, { color: colors.text.primary }]}>
