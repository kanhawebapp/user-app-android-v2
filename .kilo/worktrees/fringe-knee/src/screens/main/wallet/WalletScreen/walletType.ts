...
export const PAYMENT_METHODS: PaymentMethod[] = [
  { id: 'upi', name: WALLET_LABELS.PAYMENT_UPI, icon: 'phone-android', type: 'upi' },
  { id: 'card', name: WALLET_LABELS.PAYMENT_DEBIT_CARD, icon: 'credit-card', type: 'card' },
  { id: 'netbanking', name: WALLET_LABELS.PAYMENT_NET_BANKING, icon: 'bank', type: 'netbanking' },
  { id: 'wallet', name: WALLET_LABELS.PAYMENT_WALLET, icon: 'wallet', type: 'wallet' },
];
