...
export const OngoingLive: React.FC<OngoingLiveProps> = ({
  ...
  const { sessions: sessionsData, handleSessionPress, handleViewAllPress, isLiveSession } =
  ...
  const renderCard = ({ item }: { item: LiveSession }) => (
    ...
    >
      <View style={[styles.thumbnail, { backgroundColor: colors.background.secondary }]}>
        ...
        <Icon name="person" size={40} color={colors.text.disabled} library="MaterialIcons" />
        ...
        <View style={styles.viewerBadge}>
          <Icon name="visibility" size={12} color="#FFF" library="MaterialIcons" />
  ...
  return (
    <View style={[styles.container, style]}>
      <View style={styles.header}>
        ...
        <Button title="View All" variant="ghost" size="small" onPress={handleViewAllPress} />
      </View>
