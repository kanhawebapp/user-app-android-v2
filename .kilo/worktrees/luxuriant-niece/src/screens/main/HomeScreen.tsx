  ...
  const handleChatRequestSubmit = useCallback(
    async (data: ChatRequestData) => {
      ...
      try {
        ...
        console.log('[HomeScreen] Chat request result:', result);
        ...
        if (result.success) {
          ...
          if (result.isCall) {
            console.log(
              '[HomeScreen] Call flow initiated, navigating to CallScreen',
            );
            // Navigate to CallScreen for voice call
            navigation.navigate(
              'Call' as never,
              {
          ...
          console.error('[HomeScreen] Request failed:', result.error);
          // Show error alert maybe?
        }
      } catch (error: any) {
        console.error('[HomeScreen] Request error:', error);
      } finally {
