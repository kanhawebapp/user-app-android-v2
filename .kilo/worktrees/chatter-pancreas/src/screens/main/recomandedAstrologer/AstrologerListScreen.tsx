...
import { ChatRequestModal, ChatRequestData, LoginRequiredModal } from '../../../components/Modal';
...
const AstrologerListScreen: React.FC<AstrologerListScreenProps> = ({
  ...
  const handleCallPress = useCallback((astrologer: Astrologer) => {
  ...
  const handleChatRequestSubmit = useCallback(
    ...
    [chatTargetAstrologer, user, consultationType, navigation],
  );
