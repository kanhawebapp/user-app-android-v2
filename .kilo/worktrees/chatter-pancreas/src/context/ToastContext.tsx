...
export const ToastProvider: React.FC<{children: React.ReactNode}> = ({
  ...
  const showToastWithConfig = useCallback(
    (config: Omit<ToastConfig, 'visible'>) => {
      setToast({
        ...config,
        visible: true,
        position: config.position || 'top',
        showProgress:
          config.showProgress !== undefined ? config.showProgress : true,
        dismissOnPress:
          config.dismissOnPress !== undefined ? config.dismissOnPress : true,
        autoDismiss:
          config.autoDismiss !== undefined ? config.autoDismiss : true,
      });
    },
    [],
  );
  ...
  const showAtPosition = useCallback(
    (message: string, type: ToastType, position: ToastPosition) => {
      setToast({
        visible: true,
        message,
        type,
