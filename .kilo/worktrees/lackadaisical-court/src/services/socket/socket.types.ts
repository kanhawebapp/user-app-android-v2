...
// WebRTC signaling - new flow
   peer_joined: (data: {roomId: string}) => void;
   answer: (data: {roomId: string; answer: {type: string; sdp: string}}) => void;
   'ice-candidate': (data: {roomId: string; candidate: any}) => void;
   call_ended_by_astrologer: (data: {roomId: string}) => void;
}
...
// WebRTC signaling - new flow
   join_call: (data: {roomId: string}) => void;
   offer: (data: {
     roomId: string;
   ...
   'ice-candidate': (data: {roomId: string; candidate: any}) => void;
   call_ended_by_user: (data: {roomId: string}) => void;
}
