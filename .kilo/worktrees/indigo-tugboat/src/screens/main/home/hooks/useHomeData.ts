...
const DEFAULT_TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: 'Amazing experience! The astrology reading was very accurate and helpful.',
    date: '2 days ago',
  },
  {
    id: '2',
...
const DEFAULT_TRUST_FEATURES: TrustFeature[] = [
  ...
  },
  {
    ...
    description: '100% secure payment transactions',
    icon: 'lock',
    iconLibrary: 'MaterialIcons',
  },
  {
  ...
  },
  {
    ...
    description: 'Get refund if not satisfied',
    icon: 'thumb-up',
    iconLibrary: 'MaterialIcons',
  },
];
...
const DEFAULT_BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'Learn the basics of Kundli reading and its importance in Vedic astrology',
...
export interface UseHomeDataReturn {
  ...
  // Auth handlers
  handleRestrictedAction: (actionMessage: string, callback?: AuthActionCallback) => void;
