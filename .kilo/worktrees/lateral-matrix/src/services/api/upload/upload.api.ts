...
//     console.log('USER UPLOAD FILE PATH:', filePath);

//     const res = await ReactNativeBlobUtil.fetch(
//       'POST',
//       // IMPORTANT: USER GRAPHQL ENDPOINT
...
//     console.log('USER UPLOAD RESULT:', result);
...
//   } catch (error: any) {
//     console.log('❌ USER IMAGE UPLOAD ERROR:', error?.message || error);
//     throw error;
//   }
// };
