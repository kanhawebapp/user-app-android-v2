...
export const AUTH_LABELS = {
  ...
  CONTINUE_AS_GUEST: 'Skip for now, continue as Guest',
  ...
  OTP_SUBTITLE_DEFAULT: 'Please enter the 6-digit code sent to your phone',
...
export const WALLET_LABELS = {
  ...
  WITHDRAW: 'Withdraw',
  MIN_BALANCE_WARNING:
    'Minimum balance of ₹50 recommended for uninterrupted service',
